# Python FastAPI API with MySQL

A simple Python FastAPI API application and MySQL, containerized with Docker.
...
```bash
git clone https://github.com/opsnoopop/api_python_fastapi_mysql.git
```

### 2. Navigate to Project Directory
```bash
cd api_python_fastapi_mysql
```
